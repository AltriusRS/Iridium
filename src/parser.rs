...
pub(crate) fn parse_theme(theme: &str) -> &str {
    return match theme.to_lowercase().as_str() {
        "neon" => "html{background-color:#0e0b16;color:#e7dfdd;scroll-behavior:smooth;width:100%;height:100%}.container{margin:2em 4em}body{padding:20px;font-size:15px;font-family:\"Lucida Grande\",\"Lucida Sans Unicode\",\"Lucida Sans\",AppleSDGothicNeo-Medium,'Segoe UI','Malgun Gothic',Verdana,Tahoma,sans-serif;-webkit-font-smoothing:antialiased}a{color:#fe53bb;transition:all .4s;text-decoration:none;font-weight:500}a:hover{color:#09fbd3;transition:all .4s}h1,h2,h3,h4,h5,h6{color:#09fbd3;font-weight:700}h2{border-bottom:1px solid #21232d;line-height:1.7em}h6{color:#a4a296}hr{border:1px solid #21232d}pre>code{font-size:.9em;font-family:Consolas,Inconsolata,Courier,monospace}blockquote{border-left:4px solid #121319;padding:0 15px;font-style:italic}img{max-width:100%}table{width:100%;margin:0;border:2px solid #000;border-radius:.4em;background-color:#0f111a;color:#e7dfdd}th{font-size:large;color:#fff;border-bottom:#3498db solid 1px}table tr td,table tr th{padding:1em}table tr:nth-child(2n){background-color:#1f222c}.hljs{display:block;overflow-x:auto;padding:1.2em;background:#101320}.hljs-built_in,.hljs-link,.hljs-section,.hljs-selector-tag{color:#8be9fd}.hljs-keyword{color:#ff79c6}.hljs,.hljs-subst{color:#f8f8f2}.hljs-title{color:#50fa7b}.hljs-addition,.hljs-attr,.hljs-bullet,.hljs-meta,.hljs-name,.hljs-string,.hljs-symbol,.hljs-template-tag,.hljs-template-variable,.hljs-type,.hljs-variable{color:#f1fa8c}.hljs-comment,.hljs-deletion,.hljs-quote{color:#6272a4}.hljs-doctag,.hljs-keyword,.hljs-literal,.hljs-name,.hljs-section,.hljs-selector-tag,.hljs-strong,.hljs-title,.hljs-type{font-weight:700}.hljs-literal,.hljs-number{color:#bd93f9}.hljs-emphasis{font-style:italic}",
